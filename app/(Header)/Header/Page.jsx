...
function HeaderPage() {
  ...
  const links = [
    { name: "/template.jpg", theme: "dark" },
    { name: "/template.jpg", theme: "light" },
    { name: "/template.jpg", theme: "system" },
  ];
    ...
    <div className="">
      ...
      <nav className="flex justify-between items-center w-full  px-4 pt-10 max-w-6xl mx-auto">
        <div className="flex gap-x-3 items-center">
          ...
          <div>
            <h4 className="text-xs ">Kelasbawah</h4>
            <p className="text-[#828282] text-xs">Community Software Developer</p>
          </div>
        </div>

        <div>
          <button className="flex w-40 items-center justify-between border border-neutral-600 rounded-full p-1 px-5">
            <span className="text-xs">Get my Template</span>
            <PiArrowRightThin />
          </button>
        </div>
      </nav>
